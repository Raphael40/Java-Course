...
This is going to be rather challenging because we are using the `Scanner` class. I was able to find another library we can install to make it easier to mock user input called **System Stubs**.
